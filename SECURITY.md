...
| G13 | Server pinning is launcher-deep for interpreter servers | Hashing `npx`/`uvx` pins the launcher binary, not the package tree behind it — a poisoned transitive dependency passes T1 | v1 (frozen installs / image digests — [RFC-016](rfcs/016-server-pinning.md) T2/T3) |
